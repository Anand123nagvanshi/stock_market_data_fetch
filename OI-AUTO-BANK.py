...
######################################################################################################        
        ...
        identifiers_1=[str(X1)]
        identifiers_2=[str(X2)]
        identifiers_3=[str(X3)]
        identifiers_4=[str(X4)]
        identifiers_5=[str(X5)]
        identifiers_6=[str(X6)]
        identifiers_7=[str(X7)]
        identifiers_8=[str(X8)]
        identifiers_9=[str(X9)]
        identifiers_10=[str(X10)]
